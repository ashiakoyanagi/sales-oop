        ...
        <div class="card w-25 my-auto mx-auto">
          ...
          <div class="card-body">
            <form action="../actions/register.php" method="post">
              ...
              <!-- Bold to add emphasis -->
               ...
               <div class="mb-3">
                ...
                <input type="password" name="password" id="password" class="form-control" minlength="8" aria-describedly="password-info" required>
            ...
            <p class="text-center mt-3 small">
              Register already? <a href="../views">Log in.</a>
            </p>
          </div>
        </div>
      </div>
